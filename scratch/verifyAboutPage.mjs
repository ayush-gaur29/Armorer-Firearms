...
http.get('http://localhost:8080/about', (res) => {
  ...
  res.on('end', () => {
    ...
    console.log('Has "BIGFORK, MONTANA":', data.toLowerCase().includes('bigfork, montana'));
    ...
    console.log('Has Modern Archive Node:', data.includes('THE WORKING ATELIER'));
    ...
    console.log('Has Active About Link in Header:', data.includes('About'));
  });
