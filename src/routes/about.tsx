...
export function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-obsidian text-parchment selection:bg-brass/20 selection:text-ivory">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-6 xl:col-span-7" data-reveal>
              ...
              <div className="mt-4 flex items-center gap-3 font-mono text-[0.68rem] tracking-[0.2em] text-parchment-dim uppercase">
              ...
              <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-xl">
                <div className="border border-brass-border/40 bg-obsidian-2/60 p-3.5">
                  <p className="font-mono text-[0.58rem] tracking-[0.2em] text-brass-dark uppercase">COLLECTION</p>
                  <p className="mt-1 font-serif text-base text-ivory">120+ Historic Arms</p>
                </div>
                <div className="border border-brass-border/40 bg-obsidian-2/60 p-3.5">
                  <p className="font-mono text-[0.58rem] tracking-[0.2em] text-brass-dark uppercase">METHOD</p>
                ...
                <div className="border border-brass-border/40 bg-obsidian-2/60 p-3.5 col-span-2 sm:col-span-1">
                  <p className="font-mono text-[0.58rem] tracking-[0.2em] text-brass-dark uppercase">ETHICS</p>
            ...
            <div className="lg:col-span-6 xl:col-span-5" data-reveal-image>
              <div className="group relative border border-brass-border bg-obsidian-3 p-2 shadow-2xl transition-all duration-500 hover:border-brass/50">
                ...
                <div className="mt-2.5 flex items-center justify-between px-2 py-1 font-mono text-[0.6rem] tracking-[0.2em] text-brass-dark uppercase">
                  <span>PLATE 01 · THE BIGFORK ATELIER BENCH</span>
      ...
      =================================================== */}
      <section className="border-b border-brass-border/30 bg-obsidian-2/40 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-4xl text-center" data-reveal>
            <p className="font-mono text-[0.65rem] tracking-[0.26em] text-brass uppercase">PROVENANCE & ORIGIN</p>
            <blockquote className="mt-6 font-serif text-2xl sm:text-3xl lg:text-4xl font-light text-ivory leading-snug">
            ...
            <p className="mt-4 font-mono text-[0.68rem] tracking-[0.2em] text-brass-dark uppercase">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5" data-reveal>
              <div className="sticky top-28 space-y-6">
                ...
                <div className="border border-brass-border/30 bg-obsidian-2 p-5">
                  <p className="font-mono text-[0.62rem] tracking-[0.2em] text-brass uppercase">CURATORIAL PRINCIPLE</p>
            ...
            <div className="lg:col-span-7 space-y-8" data-reveal>
              <div className="border-l border-brass-border/40 pl-6 sm:pl-8 space-y-4">
      ...
      <section className="bg-obsidian-2/30 py-20 sm:py-28 border-b border-brass-border/30">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16" data-reveal>
            <p className="font-mono text-[0.62rem] tracking-[0.24em] text-brass uppercase">PROVEN CHRONOLOGY</p>
          ...
          <div className="grid gap-8 md:grid-cols-3 relative" data-reveal-group>
            {timelineMilestones.map((milestone, idx) => (
              <div
                key={milestone.year}
                className="relative border border-brass-border/40 bg-obsidian-2 p-8 transition-all duration-300 hover:border-brass/40"
              >
                <div className="flex items-baseline justify-between border-b border-brass-border/30 pb-4">
                  <span className="font-serif text-3xl sm:text-4xl text-brass font-light">{milestone.year}</span>
                  <span className="font-mono text-[0.6rem] tracking-[0.2em] text-brass-dark uppercase">MILESTONE 0{idx + 1}</span>
                </div>
                <h3 className="mt-5 font-serif text-lg sm:text-xl text-ivory">{milestone.label}</h3>
                <p className="mt-3 text-sm leading-relaxed text-parchment-dim">{milestone.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-28 border-b border-brass-border/30">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16" data-reveal>
            <div>
              <p className="font-mono text-[0.62rem] tracking-[0.24em] text-brass uppercase">ATELIER DOCTRINE</p>
              <h2 className="mt-3 font-serif text-3xl sm:text-4xl lg:text-5xl text-ivory font-light">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4" data-reveal-group>
            {philosophyPillars.map((p) => {
              ...
              return (
                <article
                  key={p.num}
                  className="group relative border border-brass-border/40 bg-obsidian-2/70 p-8 transition-all duration-500 hover:border-brass/60 hover:bg-obsidian-2"
                >
                  ...
                  <h3 className="mt-6 font-serif text-xl text-ivory tracking-wide">{p.title}</h3>
      ...
      =================================================== */}
      <section className="bg-obsidian-2/20 py-20 sm:py-28 border-b border-brass-border/30">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            {/* Image (58% width on desktop) */}
            <div className="lg:col-span-7" data-reveal-image>
              <div className="group border border-brass-border bg-obsidian-3 p-2 shadow-2xl transition-all duration-500 hover:border-brass/50">
                <div className="relative aspect-[4/3] overflow-hidden bg-obsidian">
                  <ArchiveImage
                ...
                <div className="mt-3 flex items-center justify-between px-2 py-1 font-mono text-[0.6rem] tracking-[0.2em] text-brass-dark uppercase">
                  <span>PLATE 02 · RAKING LIGHT EXAMINATION &amp; CONSERVATION</span>
            ...
            <div className="lg:col-span-5 space-y-6" data-reveal>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl text-ivory font-light leading-tight">
              ...
              <div className="border-t border-brass-border/30 pt-5 space-y-3 font-mono text-[0.68rem] tracking-[0.16em] text-parchment-dim uppercase">
      ...
      <section className="py-20 sm:py-28 border-b border-brass-border/30">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16" data-reveal>
            <p className="font-mono text-[0.62rem] tracking-[0.24em] text-brass uppercase">CURATORIAL STANDARDS</p>
            <h2 className="mt-3 font-serif text-3xl sm:text-4xl text-ivory font-light">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4" data-reveal-group>
            {trustPillars.map((tp, idx) => (
              <div
                key={tp.title}
                className="border border-brass-border/40 bg-obsidian-2/50 p-6 transition-all duration-300 hover:border-brass/40"
              >
                <span className="font-mono text-[0.6rem] tracking-[0.2em] text-brass uppercase">STANDARD 0{idx + 1}</span>
                <h3 className="mt-4 font-serif text-base text-ivory tracking-wide">{tp.title}</h3>
